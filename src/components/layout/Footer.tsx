        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="footer-animate">
            ...
            <p className="mb-4 text-claro">
              Somos una floristería comprometida con la calidad y la belleza. 
              Ofrecemos arreglos florales únicos para todas las ocasiones.
            </p>
          ...
          {/* Enlaces rápidos */}
          <div className="footer-animate">
            <h3 className="text-xl font-semibold mb-4 text-secundario">Enlaces rápidos</h3>
          ...
          <div className="footer-animate">
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-claro">Av. Flores 123, Ciudad Jardín</span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 mr-2 text-secundario" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="text-claro">+1 234 567 890</span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 mr-2 text-secundario" fill="none" viewBox="0 0 24 24" stroke="currentColor">
